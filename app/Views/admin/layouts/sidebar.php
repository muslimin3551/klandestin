        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <?php if (session()->get('role') == 1) { ?>
                    <li class="sidebar-item <?= ($uri1 == 'membership') ? 'active' : '' ?> ">
                        <a href="<?= base_url('admin/membership') ?>" class='sidebar-link'>
                ...
                <?php if (session()->get('role') == 1) { ?>
                    <li class="sidebar-item <?= ($uri1 == 'transaction') ? 'active' : '' ?> ">
                        <a href="<?= base_url('admin/transaction') ?>" class='sidebar-link'>
                ...
                <li class="sidebar-item <?= ($uri1 == 'article') ? 'active' : '' ?> ">
                    <a href="<?= base_url('admin/article') ?>" class='sidebar-link'>
                ...
                <li class="sidebar-item <?= ($uri1 == 'chat') ? 'active' : '' ?> ">
                    <a href="<?= base_url('admin/chat') ?>" class='sidebar-link'>
                        ...
                        <span>Chat Counselor</span>
                    </a>


                </li>
                <?php if (session()->get('role') == 1) { ?>
                    <li class="sidebar-item  <?= ($uri1 == 'counselor') ? 'active' : '' ?>">
                        <a href="<?= base_url('admin/counselor') ?>" class='sidebar-link'>
