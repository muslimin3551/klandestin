                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-1">
                                <div class="avatar bg-dark me-4">
                                    <img src="<?= base_url('uploads/user/' . $user['photos']) ?>" alt="" srcset="">
                                    <span class="avatar-status bg-success"></span>
                                </div>
                            </div>
                            <div class="col-md-11">
                                <p style="margin-bottom: 0px;"><?= $user['name']; ?></p>
                                <p style="margin-bottom: 0px;font-size: 12px;">User</p>
                            </div>
                        </div>
                    </h5>
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <form action="<?= base_url('admin/chat/add') ?>" method="post" enctype="multipart/form-data" class="w-100">
