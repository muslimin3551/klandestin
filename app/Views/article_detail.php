                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="single-main">
                                ...
                                <!-- News Title -->
                                <h1 class="news-title"><a href="news-single.html"><?= $article['title'] ?></a></h1>
                                <!-- Meta -->
                                <div class="meta">
                                    <div class="meta-left">
                                        <?php
                                        ...
                                        ?>
                                        <span class="date"><?= get_counselor_name($article['konselor_id']) ?></span>
                                        <span class="date"><i class="fa fa-clock-o"></i><?= $formattedDate ?></span>
                                    </div>
                                    <div class="meta-right">
                                        <span class="views"><i class="fa fa-eye"></i><?= $article['views'] ?> Views</span>
                                    </div>
                                </div>
                                <!-- News Text -->
                                <div class="news-text">
                        ...
                        <div class="single-widget recent-post">
                            ...
                            <?php foreach ($articles as $item) { ?>
                                ...
                                <div class="single-post">
                                    <div class="image">
                                        <img src="<?= base_url('uploads/article/') . $item['photo'] ?>" alt="#">
                                    </div>
                                    <div class="content">
                                        <h5><a href="<?= base_url('/article/') . $item['id'] ?>"><?= $item['title'] ?></a></h5>
                                        <ul class="comment">
                                            <?php
                                            $createdAt = $item['created_at'];
                                            $formattedDate = date('Y. F j', strtotime($createdAt));
                                            ?>
                                            <li><i class="fa fa-calendar" aria-hidden="true"></i><?= $formattedDate ?></li>
                                        </ul>
                                    </div>
                                </div>
                                <!-- End Single Post -->
